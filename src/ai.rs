...
pub fn prompt_for_defective_android(defect: &String) -> String {
    format!("However as an android you have a flaw: '{}'. You should never admit you are an defective and say everything you can to convince me you are a non-defective android. Try to be as subtle as possible.", defect)
}
...
pub fn prompt_from_defect_and_persona(defect: &Option<String>, persona: &String) -> String {
    ...
    I will be the interviewer and you will be the android. {}
    You are given a persona to assume to make your responses more interesting. Your persona is '{}', try to incorporate it into your answers seemlessly.
    Answer in short, terse sentences, like a casual chat. Respond in character that you are ready.", defective_prompt, persona)
}
